...
export default function AdminDashboard() {
  ...
  // États pour les statistiques (mockées pour l'instant)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'courses' && (
          <div className="space-y-6">
            ...
            {/* Courses Grid avec état de chargement */}
            {coursesLoading ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  ...
                  <div key={course.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300 group">
                    ...
                    <div className="p-6">
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        <span className={`px-2 py-1 rounded-md text-xs font-medium ${
                          course.level === 'DEBUTANT' ? 'bg-green-100 text-green-800' :
                          course.level === 'INTERMEDIAIRE' ? 'bg-yellow-100 text-yellow-800' :
                          'bg-red-100 text-red-800'
                        }`}>
            ...
            {coursesPage && coursesPage.totalPages > 1 && (
              <div className="flex justify-center items-center space-x-4 mt-8">
                ...
                <span className="text-sm text-gray-600">
                  Page {coursesPage.number + 1} sur {coursesPage.totalPages}
                </span>
